...
mapping = {
    ...
    "object_at_pose": lambda o, a: True,
    "exists": lambda e: True,
    "on_top": lambda a, b: np.random.random() < 0.5,
    "distance_reward": lambda g, o: np.random.random(),
    "gripper_open_reward": lambda g: np.random.random(),
    "gripper_close_reward": lambda g: np.random.random(),
    "rotate_reward": lambda g, o: np.random.random(),
}
