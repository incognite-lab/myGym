...
def get_parser():
    ...
    # Environment
    parser.add_argument("-cfg", "--config", type=str, default = "./trained_models/nico_grasp/A/joints_gripper_ppo/train.json", help="Config file path") #./trained_models/AG/AG_table_tiago_tiago_dual_joints_gripper_multippo/train.json
