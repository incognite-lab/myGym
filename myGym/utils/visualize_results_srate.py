...
def get_arguments():
    ...
    parser.add_argument("-common", default='table_kuka_joints')
    parser.add_argument("-algos", default=["multi"], nargs='*')
...
def main():
    ...
    for idx, algo in enumerate(args.algos):
        with open(os.path.join(args.pth, args.task, "{}_{}_{}".format(args.task, args.common, algo), "evaluation_results.json")) as f:
            data = json.load(f)
        ...
        with open(os.path.join(args.pth, args.task, "{}_{}_{}".format(args.task, args.common, algo), "train.json"), "r") as f:
