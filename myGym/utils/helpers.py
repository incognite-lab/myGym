...
def get_workspace_dict():
    ws_dict = {'baskets':  {'urdf': 'baskets.urdf', 'texture': 'baskets.jpg',
                                ...
                                'modularmaze': {'urdf': 'modularmaze.urdf', 'texture': 'verticalmaze.jpg',
                                            ...
                                            'borders':[-0.7, 0.8, 0.65, 0.65, 0.7, 1.4]},
                                'table_uni': {'urdf': 'table_universal.urdf', 'texture': 'table.jpg',
...
def get_robot_dict():
    r_dict =   {
                             ...
                             'nico_grasp': {'path': '/envs/robots/nico/nico_grasper.urdf', 'position': np.array([0.0, 0.0, 0.0]), 'orientation': [0.0, 0.0, 0], 'default_joint_ori': [-0.29, 0.66, 0.78, 1.32, 0.57, 0.79, -0.0, 0.0, -0.44], 'ee_pos': [0.1929, -0.2672, 0.2728], 'ee_ori': [0.03, -0.0444, 0.0099], 'ee_quat_ori': [0.0151, -0.0221, 0.0053, 0.9996]},
