...
def get_gripper_dict():
    g_dict ={
             ...
             "pepper": {"open": [1.57, 1.57, 1.57, 1.57], "close": [0.0, 0.0, 0.0, 0.0]},
             "tiago_dual": {"open": [0.05, 0.05], "close": [0.0, 0.0]},
             "tiago_dual_fix": {"open": [0.05, 0.05], "close": [0.0, 0.0]},
             "tiago_dual_rot": {"open": [0.05, 0.05], "close": [0.0, 0.0]},
             "tiago_dual_rotslide": {"open": [0.05, 0.05], "close": [0.0, 0.0]},
             "tiago_dual_rotslide2": {"open": [0.05, 0.05], "close": [0.0, 0.0]},
             "tiago_single": {"open": [0.05, 0.05], "close": [0.0, 0.0]},
