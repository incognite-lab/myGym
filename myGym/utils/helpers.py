...
def get_robot_dict():
    r_dict =   {
                             ...
                             'g1_full': {'path': '/envs/robots/unitree/g1_mygym_full.urdf', 'position': np.array([-0.3, 0.0, 0.07]), 'orientation': [0.0, 0.0, 0.0], 'default_joint_ori': [0.01, 0.01, -0.01, 0.04, 0.1, 0.35, -0.37, -0.19, -0.52, 0.31, -0.02, -0.64, -1.05, -0.47, -0.49, -0.14, 1.05, -0.78, 0.0, -1.04, -0.72, -0.61, 1.83, -1.85, -0.86, -0.03, -0.01, 0.01, 0.02], 'ee_pos': [-0.0961, -0.2957, 0.33], 'ee_ori': [-0.011, 0.0323, -0.0031], 'ee_quat_ori': [-0.0055, 0.0162, -0.0015, 0.9999]},
                             'g1_rotslide': {'path': '/envs/robots/unitree/g1_mygym_rotslide.urdf', 'position': np.array([-0.3, 0.0, 0.07]), 'orientation': [0.0, 0.0, 0.0], 'default_joint_ori': [-0.05, 0.0, 0.15, 0.21, -0.14, 0.27, -0.29, -0.42, -0.13, 0.32, -0.99, 0.15, -0.16, -0.08, -0.0, 0.49], 'ee_pos': [0.1457, -0.2001, 0.1976], 'ee_ori': [-0.0013, 0.0442, -0.0008], 'ee_quat_ori': [-0.0006, 0.0221, -0.0004, 0.9998]},
