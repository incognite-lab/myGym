...
def get_robot_dict():
    r_dict =   {
                             ...
                             'kuka_gripper': {'path': '/envs/robots/kuka_gripper/kuka_gripper.urdf', 'position': np.array([0.0, 0.0, 0.0]), 'orientation': [0.0, 0.0, np.pi/2], 'default_joint_ori': [0.0, 0.0, 0.0, -1.06, 0.0, 2.09, 0.0, 0.79, 0.0, 0.79, 0.0], 'ee_pos': [-0.0, 0.3468, 0.7246], 'ee_ori': [-0.01, -0.0, -0.0008]},
                             ...
                             'nico_grasp': {'path': '/envs/robots/nico/nico_grasper.urdf', 'position': np.array([0.0, 0.0, 0.0]), 'orientation': [0.0, 0.0, np.pi/2], 'default_joint_ori': [0.01, -0.01, 1.22, 1.58, 0.35, 0.0, 0.0, 0.0, 0.0], 'ee_pos': [0.2951, 0.2349, 0.1493], 'ee_ori': [0.0004, 0.0106, 1.5737]},
