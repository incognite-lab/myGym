...
def get_robot_dict():
    r_dict =   {
                             ...
                             'S2': {'path': '/envs/robots/ubtech/S2.urdf', 'position': np.array([-0.3, 0.0, 0.2]), 'orientation': [0.0, 0.0, 0], 'default_joint_ori': [-0.04, 0.35, -1.41, -0.34, -1.56, 0.07, -0.09, 0.06, 0.34, 0.07, 0.07, 0.08, 0.76], 'ee_pos': [0.1209, -0.5598, 0.4936], 'ee_ori': [-0.0011, 0.0755, -0.0131], 'ee_quat_ori': [-0.0003, 0.0378, -0.0065, 0.9993]},
