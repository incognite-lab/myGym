...
def get_robot_dict():
    r_dict =   {
                             ...
                             'icub': {'path': '/envs/robots/iCub/icub.urdf', 'position': np.array([-0.3, 0.0, 0.0]), 'orientation': [0.0, 0.0, 3.14], 'default_joint_ori': [-0.89, 2.02, 1.22, 1.7, -0.22, -0.14, -0.19, 0.83], 'ee_pos': [-0.0731, -0.281, 0.1714], 'ee_ori': [-1.6613, 0.046, 1.521], 'ee_quat_ori': [0.5455, 0.4976, -0.477, -0.4768], 'fixed': True},
