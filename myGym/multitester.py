...
parser.add_argument("-b", "--robot",  default=["panda","panda1","panda2"], nargs='*', help="what robots to test")
parser.add_argument("-ba", "--robot_action",  default=["absolute","step","absolute_gripper","step_gripper"], nargs='*', help="what actions to test")
...
parser.add_argument("-out", "--output", type=str, default="./trained_models/testernew.json", help="output file")
