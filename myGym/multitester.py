...
parser.add_argument("-cfg", "--config", type=str, default="./configs/debug.json", help="config file for evaluation")
...
parser.add_argument("-algo", "--algorithms", default=["ppo", "ppo2", "sac", "acktr", "ddpg", "td3", "trpo", "a2c","multi"], nargs='*', help="what algos to test")
