...
class ParticleFilter3D(object):
    ...
    def __init__(self, num_particles, process_std = 5, measurement_std = 5, workspace_bounds = None, dt = 0.1):
        ...
        self.vel_std = 0.05 #Unknown velocity in the beginning
    ...
    def update(self, z):
        ...
        self.vel = self.vel*0.8 + (z - self.estimate)/self.dt* 0.2#velocity change
    ...
    def resample(self):
        ...
        indexes = filterpy.monte_carlo.stratified_resample(self.weights)
