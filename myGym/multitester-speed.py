...
parser.add_argument("-mv", "--max_velocity", default=[0.1,0.5,1,10], nargs='*', help="arm speed")
parser.add_argument("-mf", "--max_force", default=[1,30,100,300], nargs='*', help="arm speed")
