...
def plot_algo_results(ax, list_results, label, c, nr):
    ...
    for i in range(len(z)):
        ax.scatter(x[i]+0.5*nr, y[i], alpha=0.5, s=z[i]*500, c='None', lw=2, edgecolors=edgecols[i], marker=verts[i])
    ...
    legend_elements = [Line2D([0], [0], linewidth=0, marker='s', color='r', label='PPO2', markersize=10),
                       ...
                       Line2D([0], [0], linewidth=0, marker='s', color='k', markerfacecolor='None', label='success high', markersize=4),
                       Line2D([0], [0], linewidth=0, marker='s', color='k', markerfacecolor='None', label='success higher', markersize=6),
                       Line2D([0], [0], linewidth=0, marker='s', color='k', markerfacecolor='None', label='success highest', markersize=8),
                       Line2D([0], [0], linewidth=0, marker='s', color=edgecols[0], markerfacecolor='None', label='num steps '+str(w_set[0]), markersize=10)]
