...
class TD3sde(OffPolicyAlgorithm):
    """
    ...
    def _setup_model(self) -> None:
        super(TD3sde, self)._setup_model()
    ...
    def excluded_save_params(self) -> List[str]:
        ...
        """
        # Exclude aliases
        return super(TD3sde, self).excluded_save_params() + ["actor", "critic", "vf_net", "actor_target", "critic_target"]
