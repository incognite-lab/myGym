...
from myGym.stable_baselines_mygym.on_policy_algorithm_old import OnPolicyAlgorithm
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data, owner in self.rollout_buffer.get(self.batch_size):
                ...
                if self.use_sde:
                    model.policy.reset_noise(self.batch_size)
...
class SubModel(MultiPPOSB3):
    def __init__(self, parent, i):
        ...
        self.policy = parent.policy_class(  # pytype:disable=not-instantiable
            parent.observation_space,
            parent.action_space,
            parent.lr_schedule,
            use_sde=parent.use_sde,
            **parent.policy_kwargs  # pytype:disable=not-instantiable
        )
